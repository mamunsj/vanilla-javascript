...
const n = 200;
const percent = Number((4 * (n / 100)).toFixed(0));
const total = n + percent;
console.log(
  `Tips for ${n} taka twenty is ${percent}, so you have to pay total : ${total}`
);
 ...
 btnTwo.style.color = "vurliwood";
 btnOne.style.color = "red";

 btnOne.addEventListener("keypress", () => {
   span.innerHTML = count++;
 });
 btnTwo.addEventListener("keypress", () => {
   span.innerHTML = count--;
 });